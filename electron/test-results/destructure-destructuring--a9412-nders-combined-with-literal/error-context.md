...
- Name: destructure.spec.ts >> destructuring variable declarations >> const [a, b] = someArray renders combined with literal
- Location: test/destructure.spec.ts:72:3
...
- Define function App
+
+     FilesApp3.tsxApp3.tsx1function App() {App. No parameters2  const [a, b] = someArray;a and b = someArray3  return null;return `null`4}5 
+     
+   
+
+
...
- table:
  - rowgroup:
    ...
    - row "2 const [a, b] = someArray; a and b = someArray":
      - cell
      - cell "2"
      - cell "const [a, b] = someArray;"
      - cell
      - cell "a and b = someArray"
